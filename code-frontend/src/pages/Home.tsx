            ...
            <div className="md:w-3/5">
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4">
                {isAuthenticated ? (
                    <Link
                        to="/dashboard"
                        className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-lg text-indigo-700 bg-white shadow-lg shadow-indigo-500/20 hover:bg-white/90 transition-all duration-300"
                    >
                      Ir para Dashboard
                    </Link>
                ) : (
                    <>
                      ...
                      <Link
                          to="/login"
                          className="inline-flex items-center justify-center px-5 py-3 border border-white/20 text-base font-medium rounded-lg text-white bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-all duration-300"
                      >
                        Já tenho uma conta
                      </Link>
                    </>
        ...
        <div className="py-20 bg-slate-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  {featuredCourses.map((course) => (
                      <div key={course.id} className="flex flex-col rounded-xl shadow-lg overflow-hidden bg-white hover:shadow-xl transition-all duration-300 group">
                        <div className="flex-shrink-0">
                          <div className="h-48 w-full bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200 group-hover:scale-105 transition-transform duration-500"></div>
                        </div>
                        ...
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800">
                          {course.level.charAt(0).toUpperCase() + course.level.slice(1)}
                            ...
                            <div className="block mt-2">
                              <p className="text-xl font-semibold text-slate-900 group-hover:text-indigo-600 transition-colors duration-300">{course.title}</p>
                          ...
                          <div className="mt-6">
                            <Link
                                ...
                                className="inline-flex items-center text-base font-semibold text-indigo-600 hover:text-indigo-500 group-hover:translate-x-1 transition-transform duration-300"
                            >
                              Ver Detalhes
            ...
            <div className="mt-12 text-center">
              <Link
                  to="/courses"
                  className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 shadow-lg shadow-indigo-500/20 transition-all duration-300"
              >
                Ver Todos os Cursos
          ...
          <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-20 lg:px-8 lg:flex lg:items-center lg:justify-between">
            <div className="lg:w-3/5">
              <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
                ...
                <span className="block text-indigo-200 mt-1">Junte-se a milhares de programadores hoje.</span>
              </h2>
            ...
            <div className="mt-8 flex lg:mt-0 lg:flex-shrink-0">
              <div className="inline-flex rounded-md shadow">
                <Link
                    to="/register"
                    className="inline-flex items-center justify-center px-6 py-4 border border-transparent text-lg font-medium rounded-lg text-indigo-700 bg-white shadow-lg shadow-indigo-500/20 hover:bg-white/90 transition-all duration-300"
                >
                  Começar Agora
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
