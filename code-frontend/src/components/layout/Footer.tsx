    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">CodeOdyssey</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/profile" className="text-gray-400 hover:text-white transition duration-200">
                  Perfil
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-2">suporte@codeodyssey.io</p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-6 text-center text-gray-400">
          <p>&copy; {currentYear} CodeOdyssey. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
